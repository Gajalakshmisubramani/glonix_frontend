        ...
        <div className="p-8 space-y-8 bg-white shadow-lg rounded-xl">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" value={vendor?.address || ""} onChange={e => setVendor({ ...vendor, address: e.target.value })} className="w-full p-2 border rounded-lg" />
            </div>
            <div>
              <label className="block mb-1 font-medium">State</label>
              <input type="text" value={vendor?.state || ""} onChange={e => setVendor({ ...vendor, state: e.target.value })} className="w-full p-2 border rounded-lg" />
            </div>
            <div>
