  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-40">
        ...
        <div className="absolute right-0 top-0 h-full w-full max-w-5xl bg-white shadow-2xl p-6 overflow-y-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-semibold text-emerald-700">Create New Bill</h2>
            <button onClick={onClose} className="px-3 py-1 rounded-xl bg-gray-100 hover:bg-gray-200">Close</button>
          </div>
            ...
            <div className="grid gap-2">
              ...
              <div className="flex gap-2">
                ...
                <button type="button" onClick={() => setShowVendorModal(true)}
                        className="px-3 whitespace-nowrap rounded-xl bg-emerald-50 text-emerald-700 border border-emerald-300 hover:bg-emerald-100">
                  + New Vendor
                </button>
              </div>
            </div>
                      ...
                      <tr key={it.id} className="border-t">
                        ...
                        <td className="p-2">
                          <button type="button" onClick={() => removeRow(it.id)}
                            className="px-3 py-1 rounded-xl bg-gray-100 hover:bg-gray-200">×</button>
                        </td>
                      </tr>
                    );
                  })}
          ...
          {/* Attachments */}
          <div className="mt-6">
            <h4 className="font-semibold text-emerald-700 mb-2">Attachments</h4>
            <div className="flex items-center gap-3 flex-wrap">
              <label className="px-3 py-2 rounded-xl border border-emerald-300 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 cursor-pointer">
                Upload Files
                <input type="file" className="hidden" multiple onChange={onPickFiles} />
              </label>
              {files.map((f) => (
                <span key={f.id} className="text-sm bg-gray-100 px-2 py-1 rounded-xl flex items-center gap-2">
                  {f.name}
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-emerald-50 rounded-xl p-4 h-fit">
              ...
              <div className="flex justify-between py-2 border-t mt-2 font-semibold text-emerald-800">
                <span>Total</span>
